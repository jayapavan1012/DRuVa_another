package com.druva.app.database;
...
import com.druva.app.model.Product;
...
public class DatabaseURLHelper extends SQLiteOpenHelper {
    private static final String LOG = "DatabaseURLHelper";
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "EmployeDatabase";
    private static final String TABLE_PRODUCT = "productUrl";
    ...
    public DatabaseURLHelper(Context context) {
